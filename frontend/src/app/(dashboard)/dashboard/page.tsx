      ...
      <aside className="w-60 flex-shrink-0 border-r border-gray-200 flex flex-col">
            ...
            <DropdownMenuTrigger asChild>
              <button className="flex w-full items-center space-x-3 rounded-md px-2 py-1.5 hover:bg-gray-100 transition-colors">
                ...
                <div className="flex-1 text-left">
                  <p className="text-sm font-medium text-gray-900">Hoang Anh</p>
        ...
        <nav className="flex-1 space-y-1 p-3 overflow-y-auto">
          ...
          <div className="space-y-1">
            <Link
              href="/dashboard"
              className="flex items-center space-x-2 rounded-md px-3 py-2 text-sm font-medium bg-gray-100 text-gray-900 transition-colors"
            >
            ...
            <Link
              ...
              className="flex items-center space-x-2 rounded-md px-3 py-2 text-sm text-gray-700 hover:bg-gray-100 transition-colors"
            >
              <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path
                  strokeLinecap="round"
